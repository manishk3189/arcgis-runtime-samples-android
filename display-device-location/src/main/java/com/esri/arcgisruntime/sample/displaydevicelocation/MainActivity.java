...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mLocationDisplay.addLocationChangedListener(new LocationDisplay.LocationChangedListener() {
      @Override public void onLocationChanged(LocationDisplay.LocationChangedEvent event) {
        LocationDataSource.Location loc = event.getLocation();
        if (loc != null && loc.getPosition() != null) {
          Log.d("location", "->" + event.getLocation().getPosition().getX() + ":" +
              event.getLocation().getPosition().getY() + ":" +
              event.getLocation().getVelocity()
